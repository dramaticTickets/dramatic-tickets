...
public class CinemaListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cinemaList.setAdapter(new SimpleAdapter(CinemaListActivity.this,cinemaData,R.layout.search_cinema_item,
        ...
        cinemaList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(CinemaListActivity.this, "您点击了影院"+ temp.get("name").toString()+"影院名为"+CinemaName, Toast.LENGTH_SHORT).show();
